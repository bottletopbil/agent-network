...
class TestLeaseManager:
    ...
    def test_lease_creation(self):
        ...
        lease_id = manager.create_lease(
            task_id="task-123", worker_id="worker-abc", ttl=300, heartbeat_interval=30
        )
...
class TestHeartbeatHandler:
    ...
    async def test_heartbeat_invalid_lease(self):
        ...
        envelope = {
            ...
            "payload": {"lease_id": "nonexistent-lease", "worker_id": "worker-key"},
        }
    ...
    async def test_heartbeat_worker_mismatch(self):
        ...
        envelope = {
            ...
            "payload": {"lease_id": lease_id, "worker_id": "worker-wrong"},
        }

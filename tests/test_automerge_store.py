...
class TestLWWAnnotations:
    ...
    def test_lww_annotations(self):
        ...
        annot_op1 = create_test_op(
            OpType.ANNOTATE, "task-1", 5, payload={"priority": "high", "owner": "alice"}
        )
...
class TestSaveAndLoad:
    ...
    def test_save_preserves_ops(self):
        ...
        ops = [create_test_op(OpType.ADD_TASK, f"task-{i}", i) for i in range(1, 6)]
...
class TestMergePeers:
    ...
    def test_merge_peers_both_tasks_appear(self):
        ...
        op_b = create_test_op(
            OpType.ADD_TASK, "task-2", 2, thread_id="thread-b", payload={"type": "test"}
        )

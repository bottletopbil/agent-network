    ...
    events = [
        ...
        },
        {
            ...
            "payload": {
                ...
                "payload": {"need_id": "need_1", "agent_id": "agent_1", "decision": "accepted"}
            }
        },
        {
            "thread_id": thread_id,
            ...
            "payload": {
                ...
                "payload": {"need_id": "need_1", "agent_id": "agent_1", "result": "success"}
            }
        }
    ]
...
class TestChaosInjection:
    ...
    def test_inject_clock_skew_does_not_go_negative(self):
        ...
        envelopes = [
            {"kind": "NEED", "lamport": 1, "timestamp_ns": 100000},  # Very small timestamp
        ]
    ...
    def test_inject_message_reorder(self):
        ...
        reordered = sim.inject_message_reorder(
            probability=1.0,  # Always reorder
            max_distance=10,
            envelopes=envelopes
        )

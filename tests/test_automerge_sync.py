...
class TestFullSync:
    ...
    def test_full_sync_two_stores(self):
        ...
        sync_a.register_peer(
            "peer-b", "nats://peer-b", sync_callback=lambda _: store_b.get_save_data()
        )
        sync_b.register_peer(
            "peer-a", "nats://peer-a", sync_callback=lambda _: store_a.get_save_data()
        )
...
class TestPeerDiscovery:
    ...
    def test_peer_discovery_initialization(self):
        ...
        discovery = PeerDiscovery("peer-a", "nats://peer-a", ["plan_sync", "consensus"])

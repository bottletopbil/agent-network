...
class TestChallengeVerification:
    ...
    async def test_agent_handles_invalid_proof_type(self):
        ...
        challenge = agent.queue.add_challenge(
            ...
            proof_data={
                'proof_type': 'INVALID_TYPE',  # Bad type
                'evidence': {}
            },
            bond_amount=25
        )
...
class TestQueueProcessing:
    ...
    def test_agent_pulls_from_queue_by_priority(self):
        ...
        agent.queue.add_challenge("low", "t1", "c1", "alice", {'proof_type': 'SCHEMA_VIOLATION', 'evidence': {}}, 50)
        agent.queue.add_challenge("high", "t2", "c2", "bob", {'proof_type': 'SCHEMA_VIOLATION', 'evidence': {}}, 500)
        agent.queue.add_challenge("mid", "t3", "c3", "charlie", {'proof_type': 'SCHEMA_VIOLATION', 'evidence': {}}, 200)
...
class TestMultipleVerifiers:
    ...
    def test_multiple_verifiers_can_claim_challenge(self):
        ...
        # Add a challenge
        queue.add_challenge("shared-c1", "t1", "c1", "alice", {'proof_type': 'SCHEMA_VIOLATION', 'evidence': {}}, 100)

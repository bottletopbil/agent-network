...
class TestPaymentChannel:
    ...
    def test_channel_creation(self):
        ...
        channel = PaymentChannel(
            channel_id="test-123", sender="alice", receiver="bob", capacity=100.0
        )
...
class TestChannelManager:
    ...
    def test_open_channel(self, manager):
        ...
        channel_id = manager.open_channel(sender="alice", receiver="bob", deposit=100.0)
    ...
    def test_verify_payment(self, manager):
        ...
        invalid_payment = Payment(
            channel_id=channel_id, amount=30.0, nonce=1, signature="wrong-signature"
        )

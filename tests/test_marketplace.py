...
class TestBidding:
    ...
    def marketplace_with_task(self):
        ...
        market.post_task("task1", "Test task", ["test"], 100.0, "user1")
    ...
    def test_get_bid_history(self, marketplace_with_task):
        ...
        marketplace_with_task.submit_bid("bid1", "task1", "agent1", 80.0, 2.0, "Bid 1")
        marketplace_with_task.submit_bid("bid2", "task1", "agent2", 70.0, 3.0, "Bid 2")
        marketplace_with_task.submit_bid("bid3", "task1", "agent3", 90.0, 1.5, "Bid 3")
...
class TestAgentRatings:
    ...
    def test_rate_agent(self, marketplace):
        ...
        rating_id = marketplace.rate_agent(
            agent_id="agent1", rater_id="user1", rating=4.5, comment="Great work!"
        )

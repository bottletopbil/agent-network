...
class TestAgentRegistration:
    ...
    def test_register_duplicate_agent_fails(self, registry):
        ...
        manifest = {"capabilities": ["test"], "pricing": {"base_rate": 5.0}}
...
class TestManifestUpdates:
    ...
    def registry_with_agent(self):
        ...
        # Register an agent
        manifest = {"capabilities": ["initial"], "pricing": {"base_rate": 10.0}}
...
class TestAgentStats:
    ...
    def test_record_task_completion(self, registry_with_agent):
        ...
        registry_with_agent.record_task_completion(
            agent_id="agent1", success=True, response_time_ms=100.0, earnings=10.0
        )
    ...
    def test_record_task_failure(self, registry_with_agent):
        ...
        # Record failed task
        registry_with_agent.record_task_completion(
            agent_id="agent1", success=False, response_time_ms=50.0, earnings=0.0
        )

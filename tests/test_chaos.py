...
from chaos.runner import (
    ChaosRunner,
    property_no_data_loss,
    property_decide_uniqueness
)
...
class TestChaosRunner:
    ...
    def test_runner_initialization(self):
        ...
        nemeses = [
            PartitionNemesis(probability=0.1),
            SlowNemesis(probability=0.1)
        ]
    ...
    def test_runner_simple_workload(self):
        ...
        # Simple property
        properties = {
            "data_exists": lambda ctx: "data" in ctx
        }
    ...
    def test_runner_with_partition(self):
        ...
        properties = {
            "agents_exist": lambda ctx: len(ctx.get("agents", [])) > 0
        }
...
class TestChaosScenarios:
    ...
    def test_slow_network_scenario(self):
        ...
        properties = {
            "messages_sent": lambda ctx: len(ctx.get("messages", [])) > 0
        }
    ...
    def test_combined_chaos_scenario(self):
        ...
        properties = {
            "has_agents": lambda ctx: len(ctx.get("agents", [])) > 0
        }

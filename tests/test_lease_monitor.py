...
class TestLeaseMonitorHeartbeat:
    ...
    def test_monitor_handles_missed_heartbeat(self):
        ...
        # Create lease
        lease_id = manager.create_lease("task-hb-miss", "worker-hb-miss", ttl=3600, heartbeat_interval=30)
    ...
    def test_monitor_no_release_for_active_heartbeats(self):
        ...
        # Create lease
        lease_id = manager.create_lease("task-hb-ok", "worker-hb-ok", ttl=3600, heartbeat_interval=3600)

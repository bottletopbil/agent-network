...
from routing.manifests import AgentManifest, ManifestRegistry, get_registry, reset_registry
...
class TestAgentManifest:
    ...
    def test_matches_capability(self):
        ...
        manifest = AgentManifest(
            agent_id="test",
            capabilities=["code_gen", "data_analysis"],
            io_schema={}
        )
...
class TestZoneRestrictions:
    ...
    def test_filter_by_zone_fallback_to_all(self, sample_manifests):
        ...
        filter = CapabilityFilter()
        need = {
            "zone": "eu-central-1"  # No agents in this zone
        }
...
class TestFilterCascade:
    ...
    def test_filter_all_no_matches(self, sample_manifests):
        ...
        need = {
            "constraints": {
                "min_memory_gb": 16  # No agents have this much memory
            },

...
class TestIngressGate:
    ...
    def test_ingress_allows_valid_envelope(self, gate_enforcer, sample_envelope):
        ...
        mock_result = PolicyResult(allowed=True, reasons=["Valid"], policy_version="1.0.0", gas_used=50)
    ...
    def test_ingress_full_evaluation(self, gate_enforcer, sample_envelope):
        ...
        mock_result = PolicyResult(allowed=True, reasons=["Valid"], policy_version="1.0.0", gas_used=100)
        
        with patch.object(gate_enforcer.wasm_runtime, 'evaluate', return_value=mock_result) as mock_eval:
...
class TestCommitGate:
    ...
    def test_commit_gate_allows_matching_resources(
        ...
        mock_result = PolicyResult(allowed=True, reasons=["Valid"], policy_version="1.0.0", gas_used=75)
...
class TestEvalDigest:
    ...
    def test_verify_detects_tampering(self):
        ...
        envelope = {
            **eval_record,
            "policy_decision": {"allow": False}  # Changed!
        }

...
def test_merge_on_heal_finds_conflicts():
    ...
    local_decides = [
        {'need_id': 'n1', 'proposal_id': 'p1', 'epoch': 1, 'lamport': 100, 'decider_id': 'a'},
        {'need_id': 'n2', 'proposal_id': 'p2', 'epoch': 1, 'lamport': 101, 'decider_id': 'a'}
    ]
    
    remote_decides = [
        {'need_id': 'n1', 'proposal_id': 'p1-alt', 'epoch': 2, 'lamport': 50, 'decider_id': 'b'},  # Conflict!
        {'need_id': 'n3', 'proposal_id': 'p3', 'epoch': 1, 'lamport': 102, 'decider_id': 'b'}  # No conflict
    ]
...
def test_merge_multiple_conflicts():
    ...
    local_decides = [
        {'need_id': 'n1', 'proposal_id': 'p1', 'epoch': 1, 'lamport': 100, 'decider_id': 'a'},
        {'need_id': 'n2', 'proposal_id': 'p2', 'epoch': 1, 'lamport': 200, 'decider_id': 'a'}
    ]
    
    remote_decides = [
        {'need_id': 'n1', 'proposal_id': 'p1-alt', 'epoch': 2, 'lamport': 50, 'decider_id': 'b'},
        {'need_id': 'n2', 'proposal_id': 'p2-alt', 'epoch': 1, 'lamport': 150, 'decider_id': 'b'}
    ]

...
class TestPayoutDistribution:
    ...
    def test_burn_amount(self, stake_manager, slashing_rules, ledger):
        ...
        assert result["total_slashed"] == (
            result["challenger_payout"] + 
            result["honest_payout"] + 
            result["burned"]
        )
...
class TestRelatedPartyBlocking:
    ...
    def test_same_org_blocking(self, relationship_detector, payout_distributor, bounty_manager, ledger):
        ...
        relationship_detector.register_party(PartyInfo(
    ...
    def test_same_asn_blocking(self, relationship_detector, payout_distributor, bounty_manager, ledger):
    ...
    def test_identity_link_blocking(self, relationship_detector, payout_distributor, bounty_manager, ledger):
...
class TestPayoutChallengePeriod:
    ...
    def test_payout_before_challenge_period_blocked(self, payout_distributor, bounty_manager, ledger):
    ...
    def test_payout_after_challenge_period_allowed(self, payout_distributor, bounty_manager, ledger):

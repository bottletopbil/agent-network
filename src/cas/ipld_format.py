...
class EnvelopeIPLD:
    ...
    def to_ipld(envelope: Dict[str, Any], cas_store=None) -> Dict[str, Any]:
        ...
        # Copy basic fields
        for key in ['v', 'id', 'thread_id', 'kind', 'lamport', 'ts_ns',
                    'sender_pk_b64', 'policy_engine_hash', 'nonce',
                    'sig_pk_b64', 'sig_b64']:
            if key in envelope:
...
class ThreadIPLD:
    ...
    def envelopes_to_dag(
        ...
        thread_dag = {
            ...
            "envelopes": [
                {"/": cid} if isinstance(cid, str) else cid
                for cid in envelope_cids
            ],
            "version": "1.0"
        }
    ...
    def dag_to_envelopes(
        self,
        thread_dag: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
        """

...
class ManifestManager:
    ...
    def sign_manifest(
        self, manifest: AgentManifest, agent_did: Optional[str] = None
    ) -> AgentManifest:
        """
        ...
        # Sign the hash
        signature = self.did_manager.sign_with_did(manifest_hash.encode("utf-8"), did)
    ...
    def verify_manifest(self, manifest: AgentManifest) -> bool:
        ...
        try:
            ...
            is_valid = self.did_manager.verify_did_signature(
                manifest_hash.encode("utf-8"), signature, manifest.agent_id
            )
    ...
    def publish_manifest(
        self, manifest: AgentManifest, registry: Optional["ManifestRegistry"] = None
    ) -> bool:
        """

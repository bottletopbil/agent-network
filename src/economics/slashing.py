...
class SlashingRules:
    ...
    def _init_schema(self):
        ...
        with self.conn:
            ...
            """)
            self.conn.execute("CREATE INDEX IF NOT EXISTS idx_slash_account ON slash_events(account_id)")
            self.conn.execute("CREATE INDEX IF NOT EXISTS idx_slash_timestamp ON slash_events(timestamp_ns)")

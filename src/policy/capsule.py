...
class CapsuleManager:
    ...
    def sign_capsule(
        self, capsule: PolicyCapsule, signer_key: Optional[str] = None
    ) -> PolicyCapsule:
        """
    ...
    def verify_capsule(
        self, capsule: PolicyCapsule, expected_signer_key: Optional[str] = None
    ) -> bool:
        """
    ...
    async def distribute_capsule(
        self, capsule: PolicyCapsule, subject: str = "policy.capsule.update"
    ) -> None:
        """
